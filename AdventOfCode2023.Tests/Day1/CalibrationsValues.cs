...
{
    public class CalibrationsValues
    {
        public static IEnumerable<string> RawCalibrationLitteral = new[]
        {
            "nqninenmvnpsz874",
        ...
        public static IEnumerable<string> RawCalibrationNonLitteral = new[]
        {
            "nqninenmvnpsz874",
            "8twofpmpxkvvdnpdnlpkhseven4ncgkb",
            "six8shdkdcdgseven8xczqrnnmthreecckfive",
